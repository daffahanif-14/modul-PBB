package com.example.modul9restapi.adapter
...
import com.example.modul9restapi.databinding.UserListBinding
...
class HomeAdapter (private var dataMahasiswa : List<DataMahasiswa>) : RecyclerView.Adapter<HomeAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.cardView.setOnClickListener {
            ...
            Navigation.findNavController(it).navigate(com.example.modul9restapi.R.id.action_homeFragment_to_detailFragment,bundle)
        }
    }
}